...
// swift-module-flags: -target x86_64-apple-ios11.0-simulator -enable-objc-interop -enable-library-evolution -swift-version 5 -enforce-exclusivity=checked -O -module-name PixelSDK
import AVFoundation
import CommonCrypto
import CoreLocation
import CoreMotion
...
@_inheritsConvenienceInitializers open class SessionFilterCannyEdgeDetection : SessionFilter {
  @objc required public init()
  required public init(from decoder: Swift.Decoder) throws
  override open func encode(to encoder: Swift.Encoder) throws
  @objc override public var normalizedIntensity: Swift.Double {
...
@objc @_hasMissingDesignatedInitializers @objcMembers public class EditController : UIKit.UIViewController {
  @objc convenience public init(session: Session)
  @objc deinit
  @objc final public let session: Session
  public var modes: [EditMode] {
    get
    set
  }
  public var currentMode: EditMode {
    get
  }
  @objc weak public var delegate: EditControllerDelegate? {
    @objc get
    @objc set
  }
...
@objc @_hasMissingDesignatedInitializers @objcMembers public class ContainerController : UIKit.UIViewController {
  ...
  convenience public init(mode: ContainerMode)
  convenience public init(modes: [ContainerMode])
  public init(modes: [ContainerMode], initialMode: ContainerMode, restoresPreviousMode: Swift.Bool = true)
  public var modes: [ContainerMode] {
    get
  }
  public var currentMode: ContainerMode {
    get
  }
  @objc weak public var delegate: ContainerControllerDelegate?
  @objc weak public var editControllerDelegate: EditControllerDelegate?
  @objc public var cameraController: CameraController {
    @objc get
  }
  @objc public var libraryController: LibraryController {
    @objc get
  }
  @objc override dynamic public func viewDidLoad()
  @objc override dynamic public func viewWillAppear(_ animated: Swift.Bool)
...
@_inheritsConvenienceInitializers open class SessionFilterNobleCornerDetection : SessionFilter {
  @objc required public init()
  required public init(from decoder: Swift.Decoder) throws
  override open func encode(to encoder: Swift.Encoder) throws
  @objc override public var normalizedIntensity: Swift.Double {
...
@objc @_hasMissingDesignatedInitializers @objcMembers public class LibraryController : UIKit.UIViewController {
  ...
  @objc final public let previewCropController: PreviewCropController
  @objc override dynamic public func viewDidLoad()
...
@objc @_hasMissingDesignatedInitializers @objcMembers public class CameraController : UIKit.UIViewController {
  @objc weak public var delegate: CameraControllerDelegate?
  @objc public var showsEditControllerWhenDone: Swift.Bool
  ...
  public var controlButtons: [CameraControlButton] {
    get
    set
  }
...
@objc @_hasMissingDesignatedInitializers @objcMembers public class PreviewCropController : UIKit.UIViewController {
  ...
  public var gridLinesMode: GridLinesMode {
    get
    set
  }
...
extension PreviewCropController : PreviewControllerDelegate {
  @objc dynamic public func previewControllerWillDisplayMedia(_ previewController: PreviewController, withSize size: CoreGraphics.CGSize)
  @objc dynamic public func previewControllerDidDisplayMedia(_ previewController: PreviewController, withSize size: CoreGraphics.CGSize)
}
...
@objc @_hasMissingDesignatedInitializers @objcMembers public class PreviewController : UIKit.UIViewController {
  ...
  @objc weak public var delegate: PreviewControllerDelegate?
  @objc override dynamic public func viewDidLoad()
  @objc override dynamic public func viewDidDisappear(_ animated: Swift.Bool)
  @objc override dynamic public func viewWillAppear(_ animated: Swift.Bool)
  ...
  @objc public var contentMode: ContentMode {
    @objc get
    @objc set
  }
...
@_hasMissingDesignatedInitializers @objcMembers public class ImageExporter {
  ...
  @objc public func export(images: [SessionImage], compressionQuality: Swift.Float = 0.95, progress: ((Swift.Double) -> Swift.Void)? = nil, completion: @escaping (Swift.Error?, [UIKit.UIImage]?) -> Swift.Void)
...
extension Array where Element : SessionFilter {
  public func copy() -> [SessionFilter]
}
