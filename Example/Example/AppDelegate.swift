...
//  PixelSDKExample
//
//  Created by Josh Bernfeld on 8/6/19.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Allow music playback when videos are playing
    ...
    @objc private func keyboardWillShow(note: Notification) {
        if let kbSize = (note.userInfo?[UIResponder.keyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue.size {
