...
install_xcframework "${PODS_ROOT}/PixelSDK-GPUImage3/framework/Build/GPUImage.xcframework" "PixelSDK-GPUImage3" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
